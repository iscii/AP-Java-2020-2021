...
public class PollDisplayPanel extends JPanel {
    ...
    private int countToDegrees(int count, int total) {
        System.out.println((double)360/((double)total/(double)count));
        return (int) Math.round((double)360/((double)total/(double)count));
    }
